...
export class UsuarioService {
  ...
  obtenerUsuarios() {
    return this.http.get<any>(base_url + 'usuario/listarUsuario').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  obtenerUsuarioParametro(nombres: any) {
    return this.http
      .get<any>(base_url + 'usuario/listarNombre/' + nombres)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  obtenerUsuario(id: number) {
    return this.http.get<any>(base_url + 'usuario/listar/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  actualizarUsuario(data: any, id: number) {
    return this.http
      .put<any>(base_url + 'usuario/actualizarUsuario/' + id, data)
      .pipe(
        map((res: any) => {
          return res;
        })
